...
public class Person {
    ...
    public ArrayList<String> getPersonFields() {
        ...
        personFields.add(String.valueOf(firstName));
        personFields.add(String.valueOf(lastName));
        personFields.add(String.valueOf(street));
        personFields.add(String.valueOf(postalCode));
        personFields.add(String.valueOf(city));
        personFields.add(String.valueOf((birthday)));
